...
【嚴格篩選條件】
1) 只收「未來」語氣
   必須包含：未來 / 明年 / 下一季 / 接下來 / 預估 / 有機會 / 會來到 / 將 / 目標價 等語氣
   過去回顧（例如：今年已經漲了、上週跳升、2025 漲幅）一律不得放入
...
2) asset 必須是「可交易股票」
   ...
   - 股票代號（2330、2317、0050…）
   - 美股 ticker（AAPL、NVDA…）
   不得使用：AI產業、半導體族群、美股七雄、台股、產業等泛稱

3) direction 必須為明確 bullish 或 bearish
   - 若只是估值區間/合理價區間，沒有明確偏多或偏空語氣：不要放
   - 若只是描述合理價，沒有方向預期：不要放

4) timeframe
   - 若有明確時間（2026年、明年、下一季、接下來三個月）必填
   - 抓不到可為 null

5) 用整段語意去判斷，不可斷句或單句判斷
...
注意：asset + direction 必填；timeframe 抓不到可為 null；evidence_quote 最多25字且避免雙引號。
"""